 ...
 *
 * 정리된 예제는 src/examples/ 에 있다. `npm run` 으로 목록을 볼 수 있다.
 * 여기서는 부담 없이 이것저것 시도해보고, 쓸 만해지면 examples/ 로 옮기면 된다.
 *
 * [자바 노트] Node/TypeScript 가 처음이라면 docs/자바개발자를-위한-노트.md 를 먼저 보자.
