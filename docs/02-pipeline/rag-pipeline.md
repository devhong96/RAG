...
- [1. 왜 RAG가 필요한가 — 전부 넣으면 안 되는 네 가지 이유](#1-왜-rag가-필요한가--전부-넣으면-안-되는-네-가지-이유)
- [2. 전체 골격 — 파이프라인은 두 개다](#2-전체-골격--파이프라인은-두-개다)
- [3. 오프라인 파이프라인](#3-오프라인-파이프라인)
- [4. 온라인 파이프라인](#4-온라인-파이프라인)
- [5. 실패 모드 여덟 개를 단계에 못 박기 (★ 이 노트의 결론)](#5-실패-모드-여덟-개를-단계에-못-박기--이-노트의-결론)
- [6. 오픈소스 세 갈래 (미검증 — 레포 확인 필요)](#6-오픈소스-세-갈래-미검증--레포-확인-필요)
