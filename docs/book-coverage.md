...
| 장 | 상태 | 현재 근거 | 남은 경계 |
|---|---|---|---|
| 1 벡터DB 소개 | 문서화 | [`vector-db.md`](vector-db.md) | SQL·NoSQL 제품별 비교 보강 가능 |
| 2 임베딩 | 문서화+실습 | [`embedding-lineage.md`](embedding-lineage.md), [`vector-math.ts`](../src/lib/vector-math.ts) | Word2Vec 자체 학습은 범위 밖 |
| 3 FAISS | 개념 반영 | [`vector-db.md`](vector-db.md) 3장 | FAISS 런타임·인덱스 팩토리 실습 없음 |
